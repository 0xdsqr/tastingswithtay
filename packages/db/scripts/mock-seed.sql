...
-- Uses ON CONFLICT DO NOTHING to allow re-running without duplicates

-- ============================================
-- RECIPES
-- ============================================

INSERT INTO recipes (title, slug, description, category, difficulty, prep_time, cook_time, servings, ingredients, instructions, tips, image, published, featured, view_count) VALUES
('Honey Glazed Salmon with Roasted Vegetables', 'honey-glazed-salmon', 'A perfectly balanced weeknight dinner that feels special. The sweet honey glaze caramelizes beautifully against the rich salmon.', 'Dinner', 'Easy', 10, 25, 4, 
...
('Rustic Sourdough Bread', 'rustic-sourdough-bread', 'The ultimate guide to achieving that perfect crust and chewy interior. This recipe uses a naturally fermented starter for deep, complex flavor.', 'Baking', 'Hard', 30, 45, 8,
...
('Spring Garden Pasta', 'spring-garden-pasta', 'Fresh asparagus, peas, and herbs tossed with al dente pasta. A celebration of spring vegetables in every bite.', 'Pasta', 'Easy', 10, 15, 4,
...
('Classic French Omelette', 'classic-french-omelette', 'Silky, tender, and perfectly rolled. Master this technique and elevate your breakfast game forever.', 'Breakfast', 'Medium', 5, 5, 1,
...
('Lemon Herb Roast Chicken', 'lemon-herb-roast-chicken', 'Golden, crispy skin and juicy meat. This Sunday roast classic never goes out of style.', 'Dinner', 'Medium', 15, 75, 6,
...
('Chocolate Lava Cakes', 'chocolate-lava-cakes', 'Rich, decadent, and impressively simple. The molten center is pure chocolate magic.', 'Dessert', 'Medium', 10, 15, 4,
...
INSERT INTO wines (name, slug, winery, region, country, vintage, type, grapes, rating, notes, aromas, pairings, price_range, occasion, image, published, featured) VALUES
('Château Margaux', 'chateau-margaux-2018', 'Château Margaux', 'Margaux, Bordeaux', 'France', 2018, 'Red', 'Cabernet Sauvignon, Merlot', 5,
...
('Sauvignon Blanc', 'cloudy-bay-sauvignon-2023', 'Cloudy Bay', 'Marlborough', 'New Zealand', 2023, 'White', 'Sauvignon Blanc', 4,
...
('Whispering Angel', 'whispering-angel-rose-2023', 'Château d''Esclans', 'Provence', 'France', 2023, 'Rosé', 'Grenache, Rolle', 4,
...
('Dom Pérignon', 'dom-perignon-2012', 'Moët & Chandon', 'Champagne', 'France', 2012, 'Sparkling', 'Chardonnay, Pinot Noir', 5,
...
('Cabernet Sauvignon', 'caymus-cabernet-2021', 'Caymus Vineyards', 'Napa Valley', 'USA', 2021, 'Red', 'Cabernet Sauvignon', 4,
...
('Riesling Spätlese', 'riesling-spatlese-2022', 'Dr. Loosen', 'Mosel', 'Germany', 2022, 'White', 'Riesling', 5,
...
('Quick', 'quick', 'recipe'),
('Gluten-Free Option', 'gluten-free-option', 'recipe'),
('Bread', 'bread', 'recipe'),
('Sourdough', 'sourdough', 'recipe'),
('Artisan', 'artisan', 'recipe'),
('Fermented', 'fermented', 'recipe'),
('Pasta', 'pasta', 'recipe'),
('Vegetarian', 'vegetarian', 'recipe'),
('Spring', 'spring', 'recipe'),
('Breakfast', 'breakfast', 'recipe'),
('Eggs', 'eggs', 'recipe'),
('French', 'french', 'both'),
('Chicken', 'chicken', 'recipe'),
('Roast', 'roast', 'recipe'),
('Sunday Dinner', 'sunday-dinner', 'recipe'),
('Classic', 'classic', 'both'),
('Dessert', 'dessert', 'recipe'),
('Chocolate', 'chocolate', 'recipe'),
('Date Night', 'date-night', 'both'),
('Impressive', 'impressive', 'both'),
('Bold', 'bold', 'wine'),
('Crisp', 'crisp', 'wine'),
('Elegant', 'elegant', 'wine'),
('Celebration', 'celebration', 'wine'),
('Summer', 'summer', 'wine')
ON CONFLICT (slug) DO NOTHING;
