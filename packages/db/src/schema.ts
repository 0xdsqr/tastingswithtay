...
export const wineTypeEnum = ["Red", "White", "Rosé", "Sparkling", "Dessert"] as const
export const priceRangeEnum = ["$", "$$", "$$$", "$$$$", "$$$$$"] as const
export const tagTypeEnum = ["recipe", "wine", "experiment", "both"] as const
export const experimentStatusEnum = ["in_progress", "paused", "completed", "graduated"] as const
export const experimentEntryTypeEnum = ["update", "photo", "note", "result", "iteration"] as const
...
export const recipes = pgTable(
  "recipes",
  {
    ...
    ingredients: jsonb("ingredients").$type<Array<{ group?: string; items: string[] }>>().notNull(),
...
export const recipeWinePairings = pgTable(
  ...
  (table) => [
    uniqueIndex("recipe_wine_pairings_unique_idx").on(table.recipeId, table.wineId),
...
export const recipeWinePairingsRelations = relations(recipeWinePairings, ({ one }) => ({
  recipe: one(recipes, {
...
export const collectionWinesRelations = relations(collectionWines, ({ one }) => ({
  collection: one(collections, {
...
export const wineCommentsRelations = relations(wineComments, ({ one, many }) => ({
  wine: one(wines, {
...
export const experimentEntriesRelations = relations(experimentEntries, ({ one }) => ({
...
export const createRecipeWinePairingSchema = createInsertSchema(recipeWinePairings, {
  recipeId: z.string().uuid(),
  wineId: z.string().uuid(),
...
export const createExperimentEntrySchema = createInsertSchema(experimentEntries, {
