...
const entryTypeConfig: Record<string, { label: string; icon: typeof Beaker; color: string }> = {
          ...
          <div className="mx-auto max-w-4xl px-6 lg:px-8">
            ...
            {experiment.hypothesis && (
              <div className="mb-8 rounded-xl border border-amber-200 bg-amber-50 p-6">
                ...
                <p className="leading-relaxed text-amber-800">{experiment.hypothesis}</p>
              </div>
            )}
            ...
            {experiment.result && (
              <div className="mb-8 rounded-xl border border-emerald-200 bg-emerald-50 p-6">
                ...
                <p className="leading-relaxed text-emerald-800">{experiment.result}</p>
              </div>
            )}
            ...
            {experiment.entries && experiment.entries.length > 0 && (
              <div className="border-t border-border pt-12">
                <h2 className="mb-8 font-serif text-2xl text-foreground">Kitchen Journal</h2>
                ...
                <div className="relative">
                  ...
                  <div className="space-y-8">
                    {experiment.entries.map((entry) => {
                      const entryConfig =
                        entryTypeConfig[entry.entryType] ?? entryTypeConfig.update!
                      ...
                      return (
                        <div key={entry.id} className="relative pl-14">
                          ...
                          <div className="rounded-xl border border-border bg-card p-6">
                            ...
                            {/* Entry images */}
                            {entry.images && (entry.images as string[]).length > 0 && (
                              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                                {(entry.images as string[]).map((img, idx) => (
