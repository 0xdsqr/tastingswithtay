    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="max-w-2xl">
              ...
              <p className="text-lg leading-relaxed text-muted-foreground">
                Explore my collection of tried-and-true recipes, from quick weeknight dinners to
                weekend baking projects. Each one is made with love and meant to be shared.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="sticky top-[73px] z-40 border-b border-border bg-background/80 py-8 backdrop-blur-md">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <RecipeFilters categories={categories} activeCategory={activeCategory} />
          </div>
        </section>
        ...
        <section className="py-12 lg:py-16">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            {recipes.length > 0 ? (
              ...
              <EmptyState
                icon={CookingPot}
                heading={activeCategory ? "No recipes in this category yet" : "No recipes yet"}
                message={
                  activeCategory
