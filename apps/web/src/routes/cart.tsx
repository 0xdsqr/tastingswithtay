    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8 lg:py-16">
          <h1 className="mb-8 font-serif text-3xl text-foreground sm:text-4xl">Your Cart</h1>
          ...
          {cartItems.length > 0 ? (
            <div className="grid gap-12 lg:grid-cols-3">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-3 flex items-center gap-2">
                          <div className="flex items-center rounded border border-border">
                            <button type="button" className="p-2 transition-colors hover:bg-muted">
              ...
              <div className="lg:col-span-1">
                <div className="rounded-lg bg-secondary p-6">
                  <h2 className="mb-6 font-serif text-xl text-foreground">Order Summary</h2>
            ...
            <div className="py-16 text-center">
              ...
              <h2 className="mb-2 font-serif text-2xl text-foreground">Your cart is empty</h2>
